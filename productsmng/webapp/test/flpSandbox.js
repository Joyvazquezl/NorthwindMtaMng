		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Products mng",
									"targetURL": "#nsproductsmng-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsproductsmng-display": {
								"semanticObject": "nsproductsmng",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.productsmng",
									"url": sap.ui.require.toUrl("ns/productsmng")
								}
							}
						}
					}
